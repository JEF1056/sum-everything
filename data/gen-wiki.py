...
title_file = open('wikiHow/titles.txt', mode="r", encoding="utf-8")
path = "wikiHow/articles"
train_data = open("../datasets/wikiHow.train", mode="w", encoding="utf-8")
val_data = open("../datasets/wikiHow.validation", mode="w", encoding="utf-8")
...
title = title_file.readline().replace("\n", "")
while title:
